			...
			<div class="latest-w3">
				<div class="container">
					...
					<div class="latest-grids">
						<div class="col-md-4 latest-grid">
							<div class="latest-top">
								<img  src="{{asset('forntEnd/images/l1.jpg')}}" class="img-responsive"  alt="">
						...
						<div class="col-md-4 latest-grid">
							<div class="latest-top">
								<img  src="{{asset('forntEnd/images/l2.jpg')}}" class="img-responsive"  alt="">
								<div class="latest-text">
									<h4>Shoes</h4>
								</div>
								<div class="latest-text2 hvr-sweep-to-top">
						...
						<div class="col-md-4 latest-grid">
							<div class="latest-top">
								<img  src="{{asset('forntEnd/images/l3.jpg')}}" class="img-responsive"  alt="">
								<div class="latest-text">
									<h4>Women</h4>
								</div>
								<div class="latest-text2 hvr-sweep-to-top">
					...
					<div class="latest-grids">
						<div class="col-md-4 latest-grid">
							<div class="latest-top">
								<img  src="{{asset('forntEnd/images/l4.jpg')}}" class="img-responsive"  alt="">
								<div class="latest-text">
									<h4>Watch</h4>
								</div>
								<div class="latest-text2 hvr-sweep-to-top">
						...
						<div class="col-md-4 latest-grid">
							<div class="latest-top">
								<img  src="{{asset('forntEnd/images/l5.jpg')}}" class="img-responsive"  alt="">
								<div class="latest-text">
									<h4>Bag</h4>
								</div>
								<div class="latest-text2 hvr-sweep-to-top">
						...
						<div class="col-md-4 latest-grid">
							<div class="latest-top">
								<img  src="{{asset('forntEnd/images/l6.jpg')}}" class="img-responsive"  alt="">
								<div class="latest-text">
									<h4>Cameras</h4>
								</div>
								<div class="latest-text2 hvr-sweep-to-top">
